...
public class GameView {
     ...
     */
    public GameView(String skin,MazeState maze, Pane root, double scale,int largeurl , int Font,Stage menuStage,int nombrepacgomme) {
        ...
        gameOverText.setFont(javafx.scene.text.Font.font(100));
        ...
        // Appliquer le style pour la couleur du texte (blanc) et l'arrière-plan transparent
        ...
        boutonQuitter.setFont(javafx.scene.text.Font.font(50));
        boutonQuitter.setStyle("-fx-text-fill: white; -fx-background-color: transparent;");
        ...
        boutonMenu.setFont(javafx.scene.text.Font.font(50));
        boutonMenu.setStyle("-fx-text-fill: white; -fx-background-color: transparent;");
        // Ajouter le bouton au StackPane
        ...
        boutonMenu.setOnAction(e -> show());
          ...
          boutonRejouer.setFont(javafx.scene.text.Font.font(50));
          boutonRejouer.setStyle("-fx-text-fill: white; -fx-background-color: transparent;");
          // Ajouter le bouton au StackPane
    ...
    public void creatVie(){
        ...
        Vie1View.setLayoutX(maze.getWidth()*scale*0.475);
        Vie1View.setLayoutY(maze.getHeight()*scale*1.05);
        Vie2View.setLayoutX(maze.getWidth()*scale*0.5);
        Vie2View.setLayoutY(maze.getHeight()*scale*1.05);
        Vie3View.setLayoutX(maze.getWidth()*scale*0.525);
