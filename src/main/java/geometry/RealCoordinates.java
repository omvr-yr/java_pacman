...
public record RealCoordinates(double x, double y) {
    ...
    // obtenir les voisin à un certain point
    ...
    public RealCoordinates floorX() {
        return new RealCoordinates((int) Math.floor(x), (int) Math.round(y));
    }

    public RealCoordinates floorY() {
        return new RealCoordinates((int) Math.round(x), (int) Math.floor(y));
    }

    public RealCoordinates ceilX() {
        return new RealCoordinates((int) Math.ceil(x), (int) Math.round(y));
    }

    public RealCoordinates ceilY() {
        return new RealCoordinates((int) Math.round(x), (int) Math.ceil(y));
    }
